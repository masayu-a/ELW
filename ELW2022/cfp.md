...
- 口頭発表 (数件) ：発表論文あり（オンサイト）
- ポスター発表：発表論文あり（オンサイト／オンライン）
- ポスター発表：発表論文なし（オンサイト／オンライン）

※ポスター発表のオンサイト発表者は「ポスター発表：発表論文あり」の方を優先します。

他に「国立国語研究所サブプロジェクト紹介」「招待講演」などの企画がございます。

#### 口頭発表：オンサイト発表者
- 国語研講堂にて対面でご発表いただきますが、zoom でも配信いたします。
*国語研で準備する機材 (Windows, Mac) での発表*をお願いします。
